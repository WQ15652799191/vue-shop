<template>
    <div>
        ...
        width="50%"
        @close="defKeys = []">
        <el-tree ref="treeRef" show-checkbox :data="rightslist" :props="{children: 'children', label: 'authName'}" node-key="id" default-expand-all :default-checked-keys="defKeys"></el-tree>
